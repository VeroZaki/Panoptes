...
## Model Architecture
![Facial Expression Model Architecture](Results/Facial_Arch.png?raw=true)

## Facial Expression Model Training and Validation Evaluation Results
![Facial Expression Model Evaluation Results](Results/Evaluation.PNG?raw=true)

## Facial Expression Model Training an Validation Accuracies Curves
![Facial Expression Model Training an Validation Accuracies Curves](Results/epoch_accuracy.svg?raw=true)
